...
(function() {
  ...
  // Design Pro is served from remodely.ai as well as the shop's own domain.
  const isProduction = ['www.surprisegranite.com', 'surprisegranite.com',
                        'www.remodely.ai', 'remodely.ai'].includes(window.location.hostname);
  ...
  window.SG_CONFIG = {
    ...
    ASSETS: {
      ...
      PLACEHOLDER_SLAB: '/images/placeholder-card.svg'
    },
